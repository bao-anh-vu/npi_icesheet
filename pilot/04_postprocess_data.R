...
plot(history$metrics$loss[2:150],type = "l")
lines(history$metrics$val_loss[2:150], col = "red") 
...
# for (checkpt in checkpts) {
    ...
    samples <- sample(1:ncol(pred_coefs), 4)
    png(paste0("./plots/pred_vs_test_fric_", setsf, "_ckpt", checkpt, ".png"), width = 2500, height = 2500)
