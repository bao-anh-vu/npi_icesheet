...
rerun_cnn <- T
sim_beds <- T
<<<<<<< HEAD:pilot/truebed/03_run_cnn.R
output_var <- "friction" # "grounding_line" # "bed" # all
=======
...
if (sim_beds) {
<<<<<<< HEAD:pilot/truebed/03_run_cnn.R
  train_data_dir <- "./simbed/training_data" #"./training_data_bed"
=======
...
<<<<<<< HEAD:pilot/truebed/03_run_cnn.R
  ...
  output_dir <- paste0("./simbed/output/", output_var, "/", setsf)
