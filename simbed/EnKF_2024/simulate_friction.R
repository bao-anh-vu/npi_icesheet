...
simulate_friction <- function(nsim, domain, sill = 8e-5, nugget = 0, range = 2.5e3) {
  ...
  # ### Plot simulations ###
  # par(mfrow = c(1,1))
  # plot(x[1:200], C_sims[1:200, 1], type = "l", col = "lavender")
  # lines(x[1:200], C_sims[1:200, 2], type = "l", col = "lightblue")
  # # lines(x[1:200], Zmat[1:200, 3], type = "l", col = "lightblue")
  # lines(x[1:200], Cmean[1:200], type = "l", col = "black")
