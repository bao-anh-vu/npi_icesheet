...
for (i in 1:length(test_samples)) {
    ...
    if (use_missing_pattern) {
        output_dir <- paste0("./output/stateaug/", setsf, "/basis/sample", s, "/missing")    
    } else {
        output_dir <- paste0("./output/stateaug/", setsf, "/basis/sample", s, "/nonmissing")    
    }
    ...
    print("Saving plots...")
    if (use_missing_pattern) {
        plot_dir <- paste0("./plots/stateaug/", setsf, "/basis/sample", s, "/missing")
    } else {
        plot_dir <- paste0("./plots/stateaug/", setsf, "/basis/sample", s, "/nonmissing")
    }
